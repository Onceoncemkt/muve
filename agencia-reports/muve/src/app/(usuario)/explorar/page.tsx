...
const NEGOCIOS_MOCK: Negocio[] = [
  ...
  { id: '19', nombre: 'Spa del Río',               categoria: 'estetica',    ciudad: 'tijuana', direccion: 'P.º del Río 6641, Río Tijuana, Tijuana',                  descripcion: 'Masajes, faciales y tratamientos corporales en zona Río.',                                  imagen_url: null, activo: true, visitas_permitidas_por_mes: 4  },
